    ...
    <!-- form -->
	 ...
	 <div class="panel-body">
		...
		<form accept-charset="UTF-8" role="form" action="incluirAdministrador" method="post">
	        ...
	        <div class="form-group">
			     <input class="form-control" placeholder="Login" name="login" type="text"  required="required" >
			</div>
			    		
            <div class="form-group">
			     <input class="form-control" placeholder="Senha" name="senha" type="password"  required="required"  >
	        </div>
