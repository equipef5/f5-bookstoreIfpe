package br.com.equipef5.library.util;
	...
	public static boolean fazerUploadImagem(MultipartFile imagem) {
		...
		if (!imagem.isEmpty()) {
			...
			try {
				...
				String workspaceProjeto = "/home/ifpe/workspace-f5/f5-bookstoreIfpe/WebContent/view/imagens";
				...
				File serverFile = new File(
						workspaceProjeto + File.separator + Calendar.getInstance().getTime() + " - " + nomeArquivo);
